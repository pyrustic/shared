...
# Class DossierEntryInfo
DossierEntryInfo(name, container, filename)

## Base Classes
tuple

## Class Attributes
\_field\_defaults &nbsp;&nbsp; \_fields &nbsp;&nbsp; \_fields\_defaults &nbsp;&nbsp; \_make &nbsp;&nbsp; container &nbsp;&nbsp; filename &nbsp;&nbsp; name
...
## \_replace
Return a new DossierEntryInfo object replacing specified fields with new values
